...
class DefaultController extends Controller
{
    ...
    public function pageAction($page)
    {
        ...
        $items = $em->createQuery("SELECT i FROM ColectaItemBundle:Item i WHERE (i INSTANCE OF Colecta\ActivityBundle\Entity\Route OR i INSTANCE OF Colecta\ActivityBundle\Entity\Place) AND i.draft = 0 ORDER BY i.date DESC")->getResult();
