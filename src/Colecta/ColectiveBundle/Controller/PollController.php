...
class PollController extends Controller
{
    ...
    public function pageAction($page)
    {
        ...
        $items = $em->getRepository('ColectaColectiveBundle:Poll')->findBy(array('draft'=>0), array('date'=>'DESC'),($this->ipp + 1), $page * $this->ipp);
        ...
        return $this->render('ColectaColectiveBundle:Poll:index.html.twig', array('items' => $items, 'categories' => $categories, 'thereAreMore' => $thereAreMore, 'page' => ($page + 1)));
    }
